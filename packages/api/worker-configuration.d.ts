/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b07dd36a55b3de279887b4e28222d59b)
// Runtime types generated with workerd@1.20260405.1 2026-04-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		LUMENS_DB: D1Database;
		EVALUATOR_AGENT_ADDRESS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EVALUATOR_AGENT_ADDRESS" | "X402_FACILITATOR_URL" | "X402_FACILITATOR_API_KEY" | "X402_PAY_TO">> {}
}
